...
from api import binance_source
...
with DAG('UserEngagment',
    ...
    data = PythonOperator(task_id='mock_data', python_callable=d.run())
    spark = spark_submit(task_id='spark_analysis', conn_id= 'spark_local', application=r'D:/projects/binanceStreaming/spark_analysis.py'
                                , retries=3)
